...
class Stacked_Gen_Regression_ver_8:
    ...
    def __init__(self,Train_Labels,Train_ALL_Features):
        ...
        Stacked_Gen_Regression_ver_8.Agg = Ridge()
        Stacked_Gen_Regression_ver_8.Sub_RF = RandomForestRegressor(random_state=0)
        Stacked_Gen_Regression_ver_8.Sub_Boost = ensemble.GradientBoostingRegressor(random_state=0)
        Stacked_Gen_Regression_ver_8.Sub_Boost2 = ensemble.GradientBoostingRegressor(random_state=0)
        ...
        sub_models = [Stacked_Gen_Regression_ver_8.Sub_Boost,
                      Stacked_Gen_Regression_ver_8.Sub_RF,Stacked_Gen_Regression_ver_8.Sub_Boost2]
        ...
        Stacked_Gen_Regression_ver_8.Agg.fit(Sub_model_preds,self.Train_Labels)
    ...
    def ModelPredict(self,feat_a):
        ...
        sub_models = [Stacked_Gen_Regression_ver_8.Sub_Boost,Stacked_Gen_Regression_ver_8.Sub_RF
                      ,Stacked_Gen_Regression_ver_8.Sub_Boost2] 
        ...
        for model in sub_models:
            ...
            if model == Stacked_Gen_Regression_ver_8.Sub_RF:
                    
                self.RF_Feature_Importances = model.feature_importances_
                    
            elif model == Stacked_Gen_Regression_ver_8.Sub_Boost:
        ...
        return Stacked_Gen_Regression_ver_8.Agg.predict(Sub_model_preds)
